defmodule KubeMQ.QueryReplyTest do
  use ExUnit.Case, async: true

  alias KubeMQ.QueryReply

  describe "new/0" do
    test "returns struct with default values" do
      reply = QueryReply.new()
      assert %QueryReply{} = reply
  ...
  describe "to_response_map/1" do
    test "converts reply struct to response map" do
      ...
      result = QueryReply.to_response_map(reply)
